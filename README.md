...
|-------|----------|------------|
|  **Naive Bayes**  |   **53.72**  |   **50.59** |
|Decision Tree  |   53.02  |   36.82 |
|     **Baseline**  |   **52.92**  |   **34.61** |
|Random Forest  |   52.92  |   37.60 |
|          MLP  |   52.53  |   39.08 |
|  Logistic L2  |   52.33  |   41.51 |
|  Logistic L1  |   52.23  |   36.60 |
|          SVM  |   51.83  |   35.56 |
|     KNN(K=5)  |   49.85  |   48.76 |
...
│   └── sml_team_project.ipynb      # 01.py와 02.py 합친 코랩 결과물 
│
├── data/
